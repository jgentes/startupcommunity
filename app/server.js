...
// new for 2.3
app.post('/api/2.3/newsletter/pass', auth.ensureAuthenticated, newsletterApis.getPass);
app.post('/api/2.3/newsletter/members', auth.ensureAuthenticated, newsletterApis.getMembers);
